    ...
    public CommandLineRunner commandLineRunner() {
        return new CommandLineRunner() {
            ...
            public void run(String... args) throws Exception {
                ...
                studentRepository.findAllByAgeGreaterThanEqual(19).forEach(System.out::println);
                System.out.println(studentRepository.countAllByIeltsScore(7.0));
                studentRepository.findAllByNameContainingIgnoreCase("D").forEach(System.out::println);
            }
        };
    }
